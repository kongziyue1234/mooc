...
class Encoder(nn.Module):
    ...
    def forward(self, x, pos):    # x : character pos:pos_text
...
class MelDecoder(nn.Module):
    ...
    def forward(self, memory, decoder_input, c_mask, pos):   #pos:mel_pos  decoder_input:mel_input
...
class Model(nn.Module):
    ...
    def forward(self, characters, mel_input, pos_text, pos_mel):
        ...
        #print('postnet_output',len(postnet_output.size()))
