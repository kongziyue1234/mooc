...
def get_spectrograms(fpath):
    ...
    #print('mag.sizemag.sizemag.size=========',mag.shape)

    # mel spectrogram
    mel_basis = librosa.filters.mel(hp.sr, n_fft=hp.n_fft, n_mels=hp.n_mels)  # (n_mels, 1+n_fft//2)
    #print('mel_basismel_basis=========================',mel_basis.shape)
